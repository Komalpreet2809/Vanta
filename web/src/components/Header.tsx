    ...
    <header className="px-6 py-4 flex items-center justify-between border-b border-[var(--border-main)] bg-[var(--bg-header)]">
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2 py-1">
          <div className="w-1.5 h-8 bg-[var(--c-green)] rounded-full opacity-30" />
          <div className="w-1.5 h-11 bg-[var(--c-green)] rounded-full opacity-60" />
          <div className="w-1.5 h-7 bg-[var(--c-green)] rounded-full opacity-40" />
          <div className="w-1.5 h-13 bg-[var(--c-green)] rounded-full opacity-80" />
          <div className="w-1.5 h-9 bg-[var(--c-green)] rounded-full opacity-50" />
        </div>
